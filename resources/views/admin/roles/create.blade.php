<x-admin.layout>
    <div class="main-content-wrap">
        <x-admin.page-heading title="Create New Role" />
        ...
        <div class="wg-box">
            <form action="{{ route('admin.roles.store') }}" method="POST">
                ...
                <fieldset class="name mb-5">
                    ...
                    <x-admin.forms.input name="name" class="mt-4" />
                </fieldset>
            ...
            {{-- <form class="form-new-product form-style-1" action="{{ route('admin.roles.store') }}" method="POST"
                ...
                <fieldset class="name">
                    <x-admin.forms.input name="name" label="Role Name" />
                </fieldset>
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="permissions-sections mt-5">
                        ...
                        @foreach ($groupedPermissions as $section => $perms)
                            <div class="permission-section">
                                <h4 class="section-title my-3">{{ ucfirst($section) }}</h4>
                                <div class="permissions-grid">
                                    @foreach ($perms as $permission)
                                        <div class="">
                                            <input type="checkbox" class="form-check-input ms-3" name="permissions[]"
