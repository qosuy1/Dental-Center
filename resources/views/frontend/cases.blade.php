<x-frontend.layout>
    ...
    {{-- <x-frontend.component.head title="{{$department->name}}" description="{{$department->}}" /> --}}

    <x-frontend.component.head title="Our Latest Cases"
        description="Our Cases" />


    <!-- cases Section -->
    <div class="max-w-6xl mx-auto px-4 py-12 text-center">
        {{-- <h1 class="text-4xl font-bold text-gray-800 my-12 text-indigo-800 ">Our Cases </h1> --}}

        {{-- filtering the data --}}
        <x-frontend.component.filtering :route="route('cases')" :isItCase="true" />
